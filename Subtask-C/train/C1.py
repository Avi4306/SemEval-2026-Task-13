...
def main():
    ...
    parser.add_argument("--submission_file", default="submission.csv")
    ...
    if args.do_predict:
        ...
        pd.DataFrame({
            "ID": test_df["ID"],
            "label": labels,
        }).to_csv(args.submission_file, index=False)
